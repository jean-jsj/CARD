...
**Structure.** A factorial grid of 8 cells (2 demand-model families × endogeneity on/off × simple/complex
market). Complex cells: 40 products, 731 stores, 156 weeks (140 public training weeks + 16 holdout-context
weeks with quantities withheld). Simple cells: 3 products, 12 stores, same schema with empty product text.
